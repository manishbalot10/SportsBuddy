...
// Brand Colors
// Primary: #E17827 (Orange)
// Secondary: #00B0F0 (Blue)
// Sport Icon Background Colors: Orange #F97316, Blue #2563EB, Green #16A34A, Purple #7C3AED, Teal #0D9488, Pink #DB2777, Yellow #F59E0B

export const SPORTS_CONFIG: Record<SportType, { color: string; icon: any; colorHex: string }> = {
  Cricket: { color: 'bg-blue-600', colorHex: '#2563EB', icon: Activity },
  Football: { color: 'bg-green-600', colorHex: '#16A34A', icon: Target },
  Hockey: { color: 'bg-orange-500', colorHex: '#F97316', icon: Activity },
  Badminton: { color: 'bg-purple-600', colorHex: '#7C3AED', icon: Zap },
  Tennis: { color: 'bg-yellow-500', colorHex: '#F59E0B', icon: Trophy },
  'Table Tennis': { color: 'bg-pink-600', colorHex: '#DB2777', icon: CircleDot },
  Kabaddi: { color: 'bg-orange-500', colorHex: '#F97316', icon: Swords },
  Wrestling: { color: 'bg-orange-500', colorHex: '#F97316', icon: Swords },
  Boxing: { color: 'bg-orange-500', colorHex: '#F97316', icon: Swords },
  Shooting: { color: 'bg-teal-600', colorHex: '#0D9488', icon: Crosshair },
  Archery: { color: 'bg-green-600', colorHex: '#16A34A', icon: Target },
  Athletics: { color: 'bg-teal-600', colorHex: '#0D9488', icon: Flag },
  Swimming: { color: 'bg-blue-600', colorHex: '#2563EB', icon: Waves },
  Volleyball: { color: 'bg-yellow-500', colorHex: '#F59E0B', icon: Activity },
  Basketball: { color: 'bg-orange-500', colorHex: '#F97316', icon: Activity },
  Chess: { color: 'bg-purple-600', colorHex: '#7C3AED', icon: Gamepad2 },
  Carrom: { color: 'bg-yellow-500', colorHex: '#F59E0B', icon: CircleDot },
  'Kho Kho': { color: 'bg-purple-600', colorHex: '#7C3AED', icon: Activity },
  Squash: { color: 'bg-teal-600', colorHex: '#0D9488', icon: Trophy },
  Golf: { color: 'bg-green-600', colorHex: '#16A34A', icon: Flag },
  Cycling: { color: 'bg-blue-600', colorHex: '#2563EB', icon: Bike },
  Weightlifting: { color: 'bg-orange-500', colorHex: '#F97316', icon: Dumbbell },
  Gymnastics: { color: 'bg-pink-600', colorHex: '#DB2777', icon: Activity },
  'Martial Arts': { color: 'bg-orange-500', colorHex: '#F97316', icon: Swords },
  Yoga: { color: 'bg-green-600', colorHex: '#16A34A', icon: PersonStanding },
  Running: { color: 'bg-teal-600', colorHex: '#0D9488', icon: Flag },
  Marathon: { color: 'bg-teal-600', colorHex: '#0D9488', icon: Flag },
