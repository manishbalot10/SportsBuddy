...
export const FilterPanel: React.FC<FilterPanelProps> = ({ filters, onFilterChange, playerCount, isLoading }) => {
    ...
    <>
      ...
      {isExpanded && (
        ...
        <div className="px-4 pb-4 md:pb-4 space-y-4 pt-4 max-h-[calc(90vh-80px)] overflow-y-auto overscroll-behavior-contain">
            ...
            {resultMessage && (
              <div 
                className={`bg-gradient-to-r from-orange-50 to-orange-100 dark:from-orange-900/20 dark:to-orange-800/20 border border-orange-200 dark:border-orange-800 rounded-xl px-4 py-3 transition-all duration-300 ${
                  shouldHighlight 
